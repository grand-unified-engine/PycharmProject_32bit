...
class Kiwoom(QAxWidget):
    ...
    def _receive_tr_data(self, screen_no, rqname, trcode, record_name, next, unused1, unused2, unused3, unused4):
        ...
        elif rqname == "opw00001_req": # opw00001 : 예수금상세현황요청
            self._opw00001(rqname, trcode)
        elif rqname == "opw00018_req": # opw00018 : 계좌평가잔고내역요청
    ...
    def _opw00001(self, rqname, trcode): # opw00001 : 예수금상세현황요청
        d2_deposit = self._comm_get_data(trcode, "", rqname, 0, 'd+2추정예수금')
        self.d2_deposit = Kiwoom.change_format(d2_deposit)

    def _opw00018(self, rqname, trcode): # opw00018 : 계좌평가잔고내역요청
        # single data
...
if __name__ == "__main__":
    ...
    # Kiwoom.set_input_value("계좌번호", "8134667711")
    # Kiwoom.set_input_value("비밀번호", "0000")
    ...
    kiwoom.set_input_value("기준일자", "20200608")
    ...
    # df = pd.DataFrame(Kiwoom.ohlcv, columns=['open', 'high', 'low', 'close', 'volume'], index=Kiwoom.ohlcv['tradetime'])
    #
    # print(df)
    #
